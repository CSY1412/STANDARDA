...
first_order_filter_type_t gesture_sensor_Gx;   //姿态传感器x轴速度
first_order_filter_type_t chassis_slow_set_vx; 
first_order_filter_type_t chassis_slow_set_vy;   
first_order_filter_type_t chassis_follow_QE;
first_order_filter_type_t chasis_power_control;
imu_data_t imu_data_access;  //姿态传感器数据
imu_data_t imu_data_temp;    //零时数据
...
/**
  ...
  * @retval         返回空
  */
float first_order_filter_cali(first_order_filter_type_t *first_order_filter_type, fp32 input)
{
