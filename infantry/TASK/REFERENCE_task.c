...
u8 rference_fifo_buff[1024];  //裁判系统fifo
FIFO_S_t  REFERENCE_FIFO;
...
void USART5_FIFO_Init(void)
{
  ...
  FIFO_S_Init(&REFERENCE_FIFO, (void *)rference_fifo_buff,1024); 
	
	judge_unpack_obj.data_fifo = &REFERENCE_FIFO;
...
void judgement_data_handler(uint8_t *p_frame)
{
  ...
  /* forward data */
//	Client_Show_Data.data1=2;
//	Client_Show_Data.data2=0;
//	Client_Show_Data.data3=1;
//	data_packet_pack(STU_CUSTOM_DATA_ID, (uint8_t *)&Client_Show_Data, sizeof(client_show_data_t), DN_REG_ID);
